                                    ...
                                    <div class="flex flex-wrap flex-row items-start space-y-3 p-6">
                                        @auth
                                            <a href="{{ route('developers.hire', $developer->id)  }}" class="transition-all group duration-200 ease-in-out border border-blue-400 hover:border-blue-600 hover:border-l-8 hover:ring-2 hover:ring-blue-600 bg-blue-50 text-base text-black-700 py-3 px-5 inline-flex items-center justify-start w-full">
                                                <div class="z-10 text-left">
                                                    ...
                                                    <p class="mb-2">Email: {{ $developer->email }}</p>
                                                    <p class="mb-2">Phone: {{ $developer->phone_numer }}</p>
                                                    <p class="text-sm font-bold">Contact →</p>
                                                </div>
                                            </a>
                                        @else
                                            <a href="{{ url('/register') }}" class="transition-all group duration-200 ease-in-out border border-yellow-400 hover:border-yellow-600 hover:border-l-8 hover:ring-2 hover:ring-yellow-600 bg-yellow-50 text-base text-yellow-700 py-3 px-5 inline-flex items-center justify-start w-full">
                                                <div class="z-10 text-left">
                                                    <p class="mb-2 font-bold">Private Information</p>
                                                    <p class="mb-2">This information is only visible with register user.</p>
                                                    <p class="text-sm font-bold">Register →</p>
                                                </div>
                                            </a>
                                        @endauth
                                        <div class="w-full">
                                            ...
                                            <p class="text-gray-600 text-base inline-flex items-center">
                                                <svg class="w-4 h-4 fill-gray-400 mr-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                                        ...
                                        <div class="w-full">
                                            ...
                                            <p class="text-gray-600 text-base inline-flex items-center">
                                                ...
                                                <span>{{ $developer->created_at->format('m/d/Y')  }}</span>
                                            </p>
                                        </div>
                                        <div class="w-full">
                                            ...
                                            <p class="text-gray-600 text-base inline-flex items-center">
                                                ...
                                                <span>{{ $developer->experience_level }}</span>
                                            </p>
                                        </div>
                                        <div class="w-full">
