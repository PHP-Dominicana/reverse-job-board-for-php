    ...
    <div class="bg-white">
        ...
        <div class="relative isolate px-6 pt-14 lg:px-8">
            ...
            <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
                <div class="text-center">
                    ...
                    <div class="mt-10 flex items-center justify-center gap-x-6">
                        <a href="{{ url('/register') }}" class="rounded-md bg-indigo-600 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Get started</a>
            ...
            <div class="flex justify-center items-center">
                <h2 class="text-xl font-medium text-gray-700 py-2">Developers available now</h2>
            </div>
            <div class="flex justify-center items-center" >
                <div class="w-1/2">
                    <ul>
                        @forelse($developers as $developer)
                            <x-developers.item
                                class="m-20 {{ $loop->first ? 'border-t border-gray-200' : '' }}"
                                :developer="$developer"/>
                        @empty
